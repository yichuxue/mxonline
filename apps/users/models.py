...
class UserProfile(AbstractUser):
    ...
    gender = models.CharField(max_length=12, choices=(("male", "男"), ("female", "女")), default="female")
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(max_length=16, choices=(('register', '注册'), ('forget', '找回密码'), ('update_email', '修改邮箱')), verbose_name='验证码类型')
